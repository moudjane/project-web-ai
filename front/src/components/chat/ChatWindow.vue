  ...
  <div class="flex-1 flex flex-col h-full bg-slate-50 text-slate-900">
    <div class="flex-1 overflow-y-auto p-8 space-y-4">
      ...
      <div v-for="(message, index) in messages" :key="index" class="flex gap-4"
        ...
        <div class="max-w-xs lg:max-w-md xl:max-w-lg px-4 py-3 rounded-lg" :class="message.role === 'user'
    ...
    <div class="p-6 border-t border-slate-200 bg-white/90 backdrop-blur-sm">
      <div class="flex items-center gap-4 w-full">
        <input v-model="prompt" type="text" placeholder="Ecris ton message ici..." :disabled="isLoading"
        ...
        <button @click="handleSendPrompt" :disabled="isLoading || !prompt.trim()"
